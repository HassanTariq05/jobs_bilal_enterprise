...
?>
            <a href='<?php echo e(Route::has("restore-$route") ? route("restore-$route", [$id]) : "#"); ?>' data-toggle="tooltip" data-placement="left" title="" data-original-title="Restore Record" class='btn btn-icon  btn-sm btn-primary'>
        ...
        ?>
            <a href='<?php echo e(Route::has("edit-$route") ? route("edit-$route", [$id]) : "#"); ?>' data-toggle="tooltip" data-placement="left" title="" data-original-title="Edit Record" class='btn btn-icon  btn-sm btn-primary'>
...
<?php $__env->stopSection(); ?><?php /**PATH C:\Users\Owais\Downloads\BE\jobs\jobs\resources\views/components/action-btn.blade.php ENDPATH**/ ?>