...
<?php $component->withAttributes([]); ?>
    <div class="row">
        <div class="col-12">
            <form method="post" action="<?php echo e(route('store-job-bill', [$job->id])); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="card">
                    <div class="card-header border-bottom">
                        <h4>Add Bill For : <span class="badge badge-secondary text-white"> Job # <?php echo e($job->job_no); ?> </span></h4>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="party_id" name="party_id">
                                        ...
                                        <option value="<?php echo e($vendor->id); ?>"><?php echo e($vendor->title); ?></option>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input id="bill_date" type="date" class="form-control" name="bill_date" value="<?php echo e(old('bill_date')); ?>" />
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input id="due_date" type="date" class="form-control" name="due_date" value="<?php echo e(old('due_date')); ?>" />
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input id="vendor_ref" type="text" class="form-control" name="vendor_ref" value="<?php echo e(old('vendor_ref')); ?>" />
                                    <?php $__errorArgs = ['vendor_ref'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php endif; ?><?php /**PATH C:\Users\Owais\Downloads\BE\jobs\jobs\resources\views/jobs/bill/add.blade.php ENDPATH**/ ?>