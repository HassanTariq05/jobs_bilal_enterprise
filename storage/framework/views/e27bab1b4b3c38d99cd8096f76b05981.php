        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
              <img src="<?php echo e(asset('assets/img/bilal_logo.jpg')); ?>" alt="JOBS" height="80" class="shadow-light rounded-circle_">
            </div>

            <div class="card card-primary">

              <div class="card-body">
                <form action="<?= route('get-login') ?>" class="login-form" method="post">
                  <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\Owais\Downloads\BE\jobs\jobs\resources\views/login.blade.php ENDPATH**/ ?>