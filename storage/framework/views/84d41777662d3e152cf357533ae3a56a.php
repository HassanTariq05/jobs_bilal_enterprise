                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                <?php if (has_permission(8)) { ?>
                                    <a href="<?php echo e(route('create-account-title')); ?>" class="btn btn-sm btn-primary">Add New</a>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="table table-hover table-striped table-sm data-table" id="table-1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($row->account_nature->title ?? ''); ?></td>
...
<?php $component = App\View\Components\ActionBtn::resolve(['route' => 'account-title','id' => ''.e($row->id).'','privilegeEditId' => '9','privilegeDeleteId' => '10','privilegeRestoreId' => ''.e($row->deleted_at ? 11 : 0).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?><?php /**PATH C:\Users\Owais\Downloads\BE\jobs\jobs\resources\views/account-titles/list.blade.php ENDPATH**/ ?>