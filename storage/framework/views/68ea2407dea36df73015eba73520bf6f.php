...
<?php $component->withAttributes([]); ?>
    <div class="row">
        <div class="col-12">
            <form method="post" action="<?php echo e(route('store-actor')); ?>" enctype='multipart/form-data'>
                <?php echo csrf_field(); ?>
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="text" id="first_name" name="first_name" value="<?php echo e(old('first_name')); ?>" class="form-control" />
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-4">
                                <input type="text" id="last_name" name="last_name" value="<?php echo e(old('last_name')); ?>" class="form-control" />
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="text" id="bio" name="bio" value="<?php echo e(old('bio')); ?>" class="form-control" />
                                <?php $__errorArgs = ['bio'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php endif; ?><?php /**PATH C:\Users\Owais\Downloads\BE\jobs\jobs\resources\views/actors/add.blade.php ENDPATH**/ ?>