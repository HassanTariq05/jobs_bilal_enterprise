                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                <?php if (has_permission(162)) { ?>
                                    <a href="<?php echo e(route('create-operation')); ?>" class="btn btn-sm btn-primary">Add New</a>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
...
<?php $component = App\View\Components\ActionBtn::resolve(['route' => 'operation','id' => ''.e($row->id).'','privilegeEditId' => '163','privilegeDeleteId' => '164','privilegeRestoreId' => ''.e($row->deleted_at ? 165 : 0).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?><?php /**PATH C:\Users\Owais\Downloads\BE\jobs\jobs\resources\views/operations/list.blade.php ENDPATH**/ ?>