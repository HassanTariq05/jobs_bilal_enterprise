...
<?php $component->withAttributes([]); ?>
    <div class="row">
        <div class="col-12">
            <form method="post" action="<?php echo e(route('store-location')); ?>" enctype='multipart/form-data'>
                <?php echo csrf_field(); ?>
                <div class="card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                <?php if (has_permission(155)) { ?>
                                    <a href="<?php echo e(route('locations')); ?>" class="btn btn-sm btn-primary">View All</a>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
...
<?php endif; ?><?php /**PATH C:\Users\Owais\Downloads\BE\jobs\jobs\resources\views/locations/add.blade.php ENDPATH**/ ?>