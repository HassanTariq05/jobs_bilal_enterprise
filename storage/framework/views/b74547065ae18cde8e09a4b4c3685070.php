                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 text-right">
                            <?php if (has_permission(210)) { ?>
                                <a href="<?php echo e(route('create-tank')); ?>" class="btn btn-sm btn-primary">Add New</a>
                            <?php } ?>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table table-hover table-striped table-sm" id="table-1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($row->capacity); ?> ltr.</td>
...
<?php $component = App\View\Components\ActionBtn::resolve(['route' => 'tank','id' => ''.e($row->id).'','privilegeEditId' => '211','privilegeDeleteId' => '212','privilegeRestoreId' => ''.e($row->deleted_at ? 213 : 0).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?><?php /**PATH C:\Users\Owais\Downloads\BE\jobs\jobs\resources\views/tanks/list.blade.php ENDPATH**/ ?>