                                ...
                                <div class="row">
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="job_no" name="job_no" value="<?php echo e(request()->input('job_no')); ?>" class="form-control" />
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group">
...
<?php $component = App\View\Components\Combobox::resolve(['of' => 'parties','label' => 'Party','ref' => 'party_id','inline' => '0','selected' => ''.e(request()->input('party_id')).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                                    ...
                                    <div class="col-md-4">
                                        <?php if (isset($component)) { $__componentOriginal40287e078f2da5df027b9b5ca93fb61e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal40287e078f2da5df027b9b5ca93fb61e = $attributes; } ?>
<?php $component = App\View\Components\Combobox::resolve(['of' => 'companies','autofocus' => 'true','label' => 'Company','ref' => 'company_id','inline' => '0','selected' => ''.e(request()->input('company_id')).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('combobox'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
                                    ...
                                    <div class="col-md-4">
                                        <?php if (isset($component)) { $__componentOriginal40287e078f2da5df027b9b5ca93fb61e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal40287e078f2da5df027b9b5ca93fb61e = $attributes; } ?>
<?php $component = App\View\Components\Combobox::resolve(['of' => 'parties','label' => 'Vendor','ref' => 'vendor_id','inline' => '0','selected' => ''.e(request()->input('vendor_id')).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('combobox'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
        ...
        <?php if (COUNT($rows)) { ?>
            ...
            <div class="col-md-6 text-right">
                <?php if (has_permission(68)) { ?>
                    <a href="<?php echo e(route('create-job')); ?>" class="btn btn-sm btn-primary">Add New Job</a>
                <?php } ?>
            </div>
            <div class="col-12">
                                ...
                                <div class="card-body">
                                    <table class="table table-hover table-striped table-sm data-table">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                            <?php if($row->jobs): ?>
                                            <?php $__currentLoopData = $row->jobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                            $jt = $job->job_totals();
                                            ...
                                            <tr class="<?php if ($job->approved) echo 'bg-success text-white'; ?>">
                                                ...
                                                <td class="text-center"><?php echo e($job->job_no); ?></td>
                                                <td class="text-center"><?php echo e($job->document_date); ?></td>
                                                <td><?php echo e($job->party->title ?? ''); ?></td>
                                                <td><?php echo e($job->job_type->title ?? ''); ?></td>
                                                <td><?php echo e($job->company->title ?? ''); ?></td>
                                                <td class="text-right"><?php echo 'Rs.' . number_format($jt['receivable'], 2); ?></td>
                                                <td class="text-right"><?php echo 'Rs.' . number_format($jt['payable'], 2); ?></td>
                                                <td class="text-right"><?php echo 'Rs.' . number_format($net, 2); ?></td>
                                                <td class="text-center">

                                                    <?php if ($c < 2) { ?>
                                                        <?php if ($job->approved) { ?>
                                                            <a href="<?php echo e(route('edit-job', [$job->id])); ?>" class="btn btn-icon  btn-sm btn-dark">
...
<?php $component = App\View\Components\ActionBtn::resolve(['route' => 'job','id' => ''.e($job->id).'','privilegeEditId' => '69','privilegeDeleteId' => '70','privilegeRestoreId' => ''.e($row->deleted_at ? 71 : 0).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?><?php /**PATH C:\Users\Owais\Downloads\BE\jobs\jobs\resources\views/jobs/list.blade.php ENDPATH**/ ?>