                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                <?php if (has_permission(156)) { ?>
                                    <a href="<?php echo e(route('create-container-size')); ?>" class="btn btn-sm btn-primary">Add New</a>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
...
<?php $component = App\View\Components\ActionBtn::resolve(['route' => 'container-size','id' => ''.e($row->id).'','privilegeEditId' => '69','privilegeDeleteId' => '70'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?><?php /**PATH C:\Users\Owais\Downloads\BE\jobs\jobs\resources\views/container-sizes/list.blade.php ENDPATH**/ ?>