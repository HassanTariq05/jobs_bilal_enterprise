...
<?php $component->withAttributes([]); ?>
    ...
    <?php if (!$job->approved) { ?>
        ...
        <?php if ($rows->count()) { ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="mt-4">
                                            <div class="row">
                                                <div class="col-6">
                                                    <a href="<?= route('create-job-invoice-detail-container-breakup', [$job->id, $inv->id]) ?>?<?= "tax_id=$tax_id&head=$head&cic=$cic" ?>" class="btn btn-danger btn-block py-2">Refresh</a>
                                                </div>
                                                <div class="col-6">
            ...
            <div class="row">
                <div class="col-12">
                    <form id="apply_rates_form" method="post" action="<?php echo e(route('store-job-invoice-detail-container-breakup', [$job->id, $inv->id])); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="card">
                            <div class="card-body">
                                <input type="hidden" name="job_invoice_id" id="job_invoice_id" value="<?= $inv->id ?>" />
                                                    ...
                                                    <tr>
                                                        <td style="text-align:center;">
                                                            <?php if (!$r->account_title_id) { ?>
                                                                <input onclick="getQtyTotal();" type="checkbox" class="container_ids" value="<?php echo e($r->container_no); ?>" data-bl_no="<?php echo e($r->bl_no); ?>" data-container_no="<?php echo e($r->container_no); ?>" data-size="<?php echo e($r->size); ?>" data-status="<?php echo e($r->status); ?>" data-vehicle_no="<?php echo e($r->vehicle_no); ?>" data-trucking_mode="<?php echo e($r->trucking_mode); ?>" data-date="<?php echo e($r->date); ?>" data-loading_port="<?php echo e($r->loading_port); ?>" data-off_loading_port="<?php echo e($r->off_loading_port); ?>" data-party="<?php echo e($r->party); ?>" data-remarks="<?php echo e($r->remarks); ?>" />
                                                            <?php } ?>
                                                        </td>
                                                        ...
                                                        <td><?php echo e($r->tax); ?></td>
                                                        <td><?php echo e(($r->rate+$r->tax)); ?></td>
                                                        <td>
                                                            <?php if($r->account_title_id): ?>
                                                            <?php echo e($r->account_title->title); ?>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="alert text-danger">
                                Sorry! no performance sheet is uploaded yet. Please <a class="text-dark" href="<?php echo e(route('create-job-performance', [$job->id])); ?>">upload Performance sheet now</a>.
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <table class="table table-sm">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="min-width:120px;text-align:right;">Invoice Amount</th>
                                                    <th style="min-width:120px;text-align:center;">Action</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php if($heads_rates): ?>
                                                <?php $__currentLoopData = $heads_rates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td><?php echo e($row->account_title->title); ?></td>
                                                    <td>
                                                        <?php echo e($row->description); ?>

                                                        <?php $inv_item_des[] = $row->description;  ?>
                                                    </td>
                                                    <td class="text-right">
                                                        <?php echo e($row->rate); ?>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <?php $inv_item_qty += $row->qty ?>
                                                    </td>
                                                    <td class="text-right">
                                                        <?php echo e($row->amount); ?>

                                                        <?php $inv_item_amount += $row->amount ?>
                                                    </td>
                                                    <td class="text-right">
                                                        <?php echo e($row->tax); ?>

                                                        <?php
                                                        $inv_item_tax += $row->tax;
                                                        $inv_item_tax_percentage += $row->tax_percentage;
                                                        ?>
                                                    </td>
                                                    <td class="text-right">
                                                        <?php echo e($row->net); ?>

                                                        <?php $inv_item_net += $row->net ?>
                                                    </td>
                                                    <td class="text-center">
                                                        <?php /*
                                                        ...
                                                        */ ?>
                                                        ...
                                                        <span onclick="deleteContainerBreakup('<?= route('destroy-job-invoice-detail-container-breakup', [$row->id]) ?>');" class="btn btn-icon btn-sm btn-danger" data-toggle="tooltip" data-placement="left" title="" data-original-title="Delete Record">
                                            ...
                                            <tfoot>
                                                <tr class="border-top">
                                                    ...
                                                    <th class="text-right">
                                                        <?php $inv_item_rate = number_format((float)($inv_item_amount / $inv_item_qty), 2, '.', ''); ?>
                                                        <?php echo e(($inv_item_rate)); ?>

                                                    </th>

                                                    <th class="text-center"><?php echo e($inv_item_qty); ?></th>
                                                    <th class="text-right"><?php echo e($inv_item_amount); ?></th>
                                                    <th class="text-right"><?php echo e($inv_item_tax); ?></th>
                                                    <th class="text-right"><?php echo e($inv_item_net); ?></th>
                            ...
                            <div class="card-footer">
                                <div class="row">
                                    <div class="col-md-12 text-right">
                                        <form method="POST" action="<?php echo e(route('store-container-breakup-invoice-item', [$job->id, $inv->id])); ?>">
                                            <?php echo csrf_field(); ?>
                                            ...
                                            <input type="hidden" name="qty" value="<?= $inv_item_qty ?>" />
                                            <input type="hidden" name="rate" value="<?= ($inv_item_rate) ?>" />
                                            <input type="hidden" name="amount" value="<?= $inv_item_amount ?>" />

                                            <input type="hidden" name="tax" value="<?= $inv_item_tax ?>" />
                                            <input type="hidden" name="tax_percentage" value="<?= number_format((float)($inv_item_tax_percentage / $counter), 2, '.', '') ?>" />
                                            <input type="hidden" name="net" value="<?= $inv_item_net ?>" />
                                            <input type="hidden" name="description" value="<?= implode(', ', $inv_item_des); ?>" />
    ...
    <?php } else { ?>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="alert alert-danger">
                    Sorry! no one is allow to add/edit invoice items.
                </div>
            </div>
        </div>
...
<?php endif; ?><?php /**PATH C:\Users\Owais\Downloads\BE\jobs\jobs\resources\views/jobs/invoice/details/container-breakup/add.blade.php ENDPATH**/ ?>