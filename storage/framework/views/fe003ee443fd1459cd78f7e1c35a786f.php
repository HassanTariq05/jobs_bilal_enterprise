                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                <?php if (has_permission(26)) { ?>
                                    <a href="<?php echo e(route('create-bank')); ?>" class="btn btn-sm btn-primary">Add New</a>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
...
<?php $component = App\View\Components\ActionBtn::resolve(['route' => 'bank','id' => ''.e($row->id).'','privilegeEditId' => '27','privilegeDeleteId' => '28','privilegeRestoreId' => ''.e($row->deleted_at ? 29 : 0).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?><?php /**PATH C:\Users\Owais\Downloads\BE\jobs\jobs\resources\views/banks/list.blade.php ENDPATH**/ ?>