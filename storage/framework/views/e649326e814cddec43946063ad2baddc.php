                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                <?php if (has_permission(168)) { ?>
                                    <a href="<?php echo e(route('create-fuel-type')); ?>" class="btn btn-sm btn-primary">Add New</a>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
...
<?php $component = App\View\Components\ActionBtn::resolve(['route' => 'fuel-type','id' => ''.e($row->id).'','privilegeEditId' => '169','privilegeDeleteId' => '170','privilegeRestoreId' => ''.e($row->deleted_at ? 171 : 0).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?><?php /**PATH C:\Users\Owais\Downloads\BE\jobs\jobs\resources\views/fuel-types/list.blade.php ENDPATH**/ ?>