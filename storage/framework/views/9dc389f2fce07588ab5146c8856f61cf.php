...
<?php $component->withAttributes([]); ?>
    <div class="row">
        <div class="col-12">
            <form method="post" action="<?php echo e(route('store-booking')); ?>" id="myForm" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                <?php if (has_permission(67)) { ?>
                                    <a href="<?php echo e(route('bookings')); ?>" class="btn btn-sm btn-primary">View All</a>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
...
<?php $component = App\View\Components\Combobox::resolve(['of' => 'locations','label' => 'Loading Port','ref' => 'loading_port','inline' => '0'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                            ...
                            <div class="col-md-4">
                                <?php if (isset($component)) { $__componentOriginal40287e078f2da5df027b9b5ca93fb61e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal40287e078f2da5df027b9b5ca93fb61e = $attributes; } ?>
<?php $component = App\View\Components\Combobox::resolve(['of' => 'locations','label' => 'Off Load','ref' => 'off_load','inline' => '0'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('combobox'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
                            ...
                            <div class="col-md-4">
                                <?php if (isset($component)) { $__componentOriginal40287e078f2da5df027b9b5ca93fb61e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal40287e078f2da5df027b9b5ca93fb61e = $attributes; } ?>
<?php $component = App\View\Components\Combobox::resolve(['of' => 'parties','label' => 'Customer','ref' => 'customer','inline' => '0'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('combobox'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
                            ...
                            <div class="col-md-4">
                                <?php if (isset($component)) { $__componentOriginal40287e078f2da5df027b9b5ca93fb61e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal40287e078f2da5df027b9b5ca93fb61e = $attributes; } ?>
<?php $component = App\View\Components\Combobox::resolve(['of' => 'locations','label' => 'Location','ref' => 'location','inline' => '0'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('combobox'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" id="date" name="date" value="<?php echo e(old('date')); ?>" class="form-control"/>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="col-gray-200 border rounded-1 p-2 !border-gray-300" style="border-radius: 0.2rem;">
                                                <a href="<?php echo e(asset('assets/add_booking_containers_sample.xlsx')); ?>" download="Sample_Format_Add_Booking.xlsx" class="text-primary">
...
//echo "<pre>"; print_r($errors_report); <?php if (COUNT($errors_report)) {
    ...
    <script>
        ...
        document.getElementById('nav-manual-entry-tab').addEventListener('click', function() {
            ...
            form.setAttribute('action', '<?php echo e(route("store-booking-manually")); ?>');
        });

        document.getElementById('nav-upload-file-tab').addEventListener('click', function() {
            const form = document.getElementById('myForm');
            form.setAttribute('action', '<?php echo e(route("store-booking")); ?>');
        });
    </script>
...
<?php endif; ?><?php /**PATH /Users/i2p/Downloads/jobs/jobs/resources/views/bookings/add.blade.php ENDPATH**/ ?>