...
<?php $component->withAttributes([]); ?>
    ...
    <div class="row">
        <div class="col-12">
            <form method="post" action="<?php echo e(route('upload-job-performance-sheet', [Request::segment(3)])); ?>" enctype='multipart/form-data'>
                <?php echo csrf_field(); ?>
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <a href="<?php echo e(asset('assets/job_performance_sample.xlsx')); ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Download Sample File" class="btn btn-primary m-2">
                                    Data Sample File
                                </a>
                                <a href="<?php echo e(route('download-locations-master', [Request::segment(3)])); ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Download Location Master File" class="btn btn-info m-2">
                                    Location Master File
                                </a>
                                <a href="<?php echo e(route('download-parties-master', [Request::segment(3)])); ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Download Party Master File" class="btn btn-info m-2">
                                    Party Master File
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="card-footer">
                            <div class="row">
                                ...
                                <div class="col-md-3 text-right">
                                    <form method="post" action="<?php echo e(route('store-job-performance', [Request::segment(3)])); ?>">
                                        <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\Users\Owais\Downloads\BE\jobs\jobs\resources\views/jobs/performance/add.blade.php ENDPATH**/ ?>