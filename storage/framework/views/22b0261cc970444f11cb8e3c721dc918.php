...
<?php $component->withAttributes([]); ?>
    <div class="row">
        <div class="col-12">
            <form method="post" action="<?php echo e(route('store-account-nature')); ?>" enctype='multipart/form-data'>
                <?php echo csrf_field(); ?>
                <div class="card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                <?php if (has_permission(1)) { ?>
                                    <a href="<?php echo e(route('account-natures')); ?>" class="btn btn-sm btn-primary">View All</a>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Code Start From</label>
                            <div class="col-sm-12 col-md-4">
                                <input type="text" id="code" name="code" value="<?php echo e(old('code')); ?>" class="form-control" />
...
<?php endif; ?><?php /**PATH C:\Users\Owais\Downloads\BE\jobs\jobs\resources\views/account-natures/add.blade.php ENDPATH**/ ?>