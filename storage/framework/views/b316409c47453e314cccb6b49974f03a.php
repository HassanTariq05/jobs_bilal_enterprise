                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                <?php if (has_permission(156)) { ?>
                                    <a href="<?php echo e(route('create-location')); ?>" class="btn btn-sm btn-primary">Add New</a>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
...
<?php $component = App\View\Components\ActionBtn::resolve(['route' => 'location','id' => ''.e($row->id).'','privilegeEditId' => '157','privilegeDeleteId' => '158','privilegeRestoreId' => ''.e($row->deleted_at ? 159 : 0).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?><?php /**PATH C:\Users\Owais\Downloads\BE\jobs\jobs\resources\views/locations/list.blade.php ENDPATH**/ ?>