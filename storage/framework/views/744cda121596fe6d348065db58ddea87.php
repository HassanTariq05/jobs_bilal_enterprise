            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" <?php if($seg1=='jobs' ): ?> style="display: block;" <?php endif; ?>>
                ...
                <?php if (has_permission(67)) { ?>
                  <li class="<?php if($seg1=='jobs' && $seg2==''): ?> active <?php endif; ?>"><a class="nav-link" href="/jobs">Job Queue</a></li>
                <?php } ?>

                <?php if (has_permission(68)) { ?>
                  <li class="<?php if($seg1=='jobs' && $seg2=='add'): ?> active <?php endif; ?>"><a class="nav-link" href="/jobs/add">Add New Job</a></li>
                <?php } ?>
              ...
              <ul class="dropdown-menu" <?php if($seg1=='bookings' ): ?> style="display: block;" <?php endif; ?>>
                ...
                <?php if (has_permission(67)) { ?>
                  <li class="<?php if($seg1=='bookings' && $seg2==''): ?> active <?php endif; ?>"><a class="nav-link" href="/bookings">Booking Queue</a></li>
                <?php } ?>

                <?php if (has_permission(68)) { ?>
                  <li class="<?php if($seg1=='bookings' && $seg2=='add'): ?> active <?php endif; ?>"><a class="nav-link" href="/bookings/add">Add New Booking</a></li>
                <?php } ?>
              ...
              <ul class="dropdown-menu" <?php if(in_array($seg1, $items)): ?> style="display: block;" <?php endif; ?>>
                ...
                <?php if(has_permission(25)) { ?>
                  <li class="<?php if($seg1=='container'): ?> active <?php endif; ?>">
                    <a class="nav-link" href="/container-sizes">Container Size</a>
                  </li>
                <?php } ?>
...
</html><?php /**PATH C:\Users\Owais\Downloads\BE\jobs\jobs\resources\views/components/layout-admin.blade.php ENDPATH**/ ?>