                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                <?php if (has_permission(216)) { ?>
                                    <a href="<?php echo e(route('create-user-status')); ?>" class="btn btn-sm btn-primary">Add New</a>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
...
<?php endif; ?><?php /**PATH C:\Users\Owais\Downloads\BE\jobs\jobs\resources\views/users-status/list.blade.php ENDPATH**/ ?>