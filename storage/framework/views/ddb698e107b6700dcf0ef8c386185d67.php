                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="bl_no" name="bl_no" value="<?php echo e(old('bl_no')); ?>" class="form-control" required />
...
<?php endif; ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" id="date" name="date" value="<?php echo e(old('date')); ?>" class="form-control" required />
...
<?php endif; ?><?php /**PATH C:\Users\Owais\Downloads\BE\jobs\jobs\resources\views/bookings/add.blade.php ENDPATH**/ ?>