                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                <?php if (has_permission(180)) { ?>
                                    <a href="<?php echo e(route('create-job-type')); ?>" class="btn btn-sm btn-primary">Add New</a>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
...
<?php $component = App\View\Components\ActionBtn::resolve(['route' => 'job-type','id' => ''.e($row->id).'','privilegeEditId' => '181','privilegeDeleteId' => '182','privilegeRestoreId' => ''.e($row->deleted_at ? 183 : 0).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                                            <?php /*
                                            <a href="{{route('edit-job-type', [$row->id])}}" class="btn btn-icon  btn-sm btn-primary"><i class="far fa-edit"></i></a>
...
<?php endif; ?><?php /**PATH C:\Users\Owais\Downloads\BE\jobs\jobs\resources\views/job-types/list.blade.php ENDPATH**/ ?>