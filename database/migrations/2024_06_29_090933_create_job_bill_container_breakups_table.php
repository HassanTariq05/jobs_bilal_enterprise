...
return new class extends Migration
{
    ...
    {
        Schema::create('job_bill_container_breakups', function (Blueprint $table) {
            $table->id();
            $table->foreignId('job_bill_id');
            $table->foreignId('job_bill_detail_id')->nullable();
    ...
    {
        Schema::dropIfExists('job_bill_container_breakups');
    }
};
