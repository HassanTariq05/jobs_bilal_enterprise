          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" @if($seg1=='bookings' ) style="display: block;" @endif>
                ...
                <?php if (has_permission(67)) { ?>
                  <li class="@if($seg1=='bookings' && $seg2=='') active @endif"><a class="nav-link" href="/bookings">Booking Queue</a></li>
                <?php } ?>

                <?php if (has_permission(68)) { ?>
                  <li class="@if($seg1=='bookings' && $seg2=='add') active @endif"><a class="nav-link" href="/bookings/add">Add New Booking</a></li>
                <?php } ?>
