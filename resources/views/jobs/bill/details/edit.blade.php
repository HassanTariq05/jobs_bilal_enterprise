<x-layout-admin>
    ...
    <div class="row">
        <div class="col-12">
            <form method="post" action="{{route('update-job-bill-detail', [$job->id, $bill->id, $row->id])}}">
                @csrf
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input id="rate" onkeyup="calculate_amount_by_rate_qty();" type="text" class="form-control float" name="rate" value="{{$row->rate}}" />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="qty">Qty</label>
                                    <input id="qty" onkeyup="calculate_amount_by_rate_qty();" type="number" class="form-control" name="qty" value="{{$row->qty}}" />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="amount">Amount Excluding Tax</label>
                                    <input id="amount" onkeyup="reset_tax_amount();" type="text" class="form-control float" name="amount" value="{{$row->amount}}" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="input-group mb-2">
                                    <input id="tax_percentage" type="text" onkeyup="calculate_tax_amount(); sumup();" title="Tax percent" class="form-control float" name="tax_percentage" value="" placeholder="tax percentage" />
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">%</div>
                                    </div>
                                    <input id="tax" type="text" onkeyup="calculate_tax_percentage(); sumup();" title="Tax amount" class="form-control float" name="tax" value="{{$row->tax}}" placeholder="tax amount" />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
