<x-layout-admin>
    ...
    <form id="receiptForm" method="post" action="{{route('update-job-receipt', [$row->id])}}">
        @csrf
                                ...
                                <tbody id="invoices_container">
                                    ...
                                    ?>
                                                <tr id="inv_row_<?= $item->id ?>">
                                                    ...
                                                    <td>{{$inv_info->inv_no}}</td>
                                                    <td>{{$inv_info->job->job_no}}</td>
                                                    <td>{{$inv_info->job->location->title }}</td>
                                                    <td title="{{$inv_info->party->title}}">{{$inv_info->party->short_name}}</td>
                                                    <td class="text-right balance">{{$inv_info->job_invoice_balance()}}</td>

                                                    <td><input style="width:100px" name="sales_tax_with_held[]" id="sales_tax_with_held" type="number" onkeyup="get_Row_total(<?= $item->id ?>); generateSummary();" class="form-control float sales_tax_with_held sales_tax_with_held_<?= $item->id ?>" value="{{$item->sales_tax_with_held}}" /></td>
                                                    <td><input style="width:100px" name="income_tax_with_held[]" id="income_tax_with_held" type="number" onkeyup="get_Row_total(<?= $item->id ?>); generateSummary();" class="form-control float income_tax_with_held income_tax_with_held_<?= $item->id ?>" value="{{$item->income_tax_with_held}}" /></td>
                                                    <td>
                                                    ...
                                                    <td><input style="width:100px" name="adjustment_amount[]" id="adjustment_amount" type="number" onkeyup="get_Row_total(<?= $item->id ?>); generateSummary();" class="form-control float adjustment_amount adjustment_amount_<?= $item->id ?>" value="{{$item->adjustment_amount}}" /></td>

                                                    <td><input style="width:100px" name="received_amount[]" type="number" onkeyup="get_Row_total(<?= $item->id ?>); generateSummary();" class="form-control float invoice_received_amount invoice_received_amount_<?= $item->id ?>" value="{{$item->received_amount}}" /></td>
                                                    <td><input style="width:100px" name="invoice_row_total[]" type="number" onchange="generateSummary();" class="form-control invoice_row_total  float invoice_row_total_<?= $item->id ?>" value="{{$total}}" /></td>
                                                </tr>
                                    <?php
                                            }
                                        }
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4">
                                <x-combobox of="banks" label="Bank" selected="{{$row->bank_id}}" ref="bank_id" inline=0 />
                                <div class="text-danger bi-error"></div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="instrument_amount">Instrument Amount</label>
                                    <input onkeyup="generateSummary();" type="text" class="form-control float instrument_amount" name="instrument_amount" value="{{$row->instrument_amount}}" />
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input id="received_from" type="text" class="form-control" name="received_from" value="{{$row->received_from}}" />
                                </div>
                            </div>
                            <div class="col-md-4">
