        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header border-bottom">
                    <div class="row">
                        <div class="col-md-6">
                            <h4>Edit Invoice Container Breakup Data</h4>
                        </div>
                        <div class="col-md-6 text-right">
                            <a class="btn btn-dark" href="{{route('edit-job', [$job->id])}}">View Job</a>
                            <a class="btn btn-primary" href="{{route('create-job-invoice-detail', [$job->id, $inv->id])}}">View Invoice</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                                    ...
                                    <table class="table table-sm ">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <span onclick="deleteContainerBreakup('<?= route('trash-job-invoice-detail-container-breakup', [$row->id, $container_item_code]) ?>');" class="btn btn-icon btn-sm btn-danger" data-toggle="tooltip" data-placement="left" title="" data-original-title="Delete Record">
                                                    ...
                                                    <div class="text-right p-2">
                                                        ...
                                                        <?php if ($row->items->count()) { ?>
                                                                            ...
                                                                            <tr class="text-center">
                                                                                ...
                                                                                <td>
                                                                                    <?php /*
                                                                                        ...
                                                                                        */ ?>
                                                                                    <span onclick="deleteContainerBreakup('<?= route('trash-job-invoice-detail-container-breakup-item', [$item->id, $container_item_code]) ?>');" class="btn btn-icon btn-sm btn-danger" data-toggle="tooltip" data-placement="left" title="" data-original-title="Delete Record">
                                                                                        <i class="fas fa-trash"></i>
                                                                                    </span>
                                                                                </td>
                                                                            </tr>
                                                            ...
                                                            <div class="text-left shadow-sm p-3">
                                                                <form method="post" action="{{route('update-invoice-items-rate')}}">
                                                                    @csrf
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <div class="shadow p-4 bg-secondary">
                                                                                ...
                                                                                <input type="hidden" name="job_invoice_container_breakup_id" value="<?= $row->id ?>" />
                                                                                <div class="row">
                                                                                    <div class="col-md-6">
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-md-6">
                                                                                        <div class="form-group">
                                                                                            <label for="net<?= $row->id ?>">Invoice Amount</label>
                                        ...
                                        <tfoot>
                                            <tr class="border-top">
                                                ...
                                                <th class="text-right">{{@amount($inv_item_amount)}}</th>
                                                <th class="text-right">{{@amount($inv_item_tax)}}</th>
                                                <th class="text-right">{{@amount($inv_item_net)}}</th>
