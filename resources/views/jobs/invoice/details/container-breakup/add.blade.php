<x-layout-admin>
    ...
    <?php if (!$job->approved) { ?>
        ...
        <?php //if (count($rows)) { ?>
            ...
            <div class="row">
                <div class="col-12">
                    <form id="apply_rates_form" method="post" action="{{route('store-job-invoice-detail-container-breakup', [$job->id, $inv->id])}}">
                        @csrf
                        <div class="card">
                            <div class="card-body">
                                        ...
                                        <table class="table table-sm">
                                            ...
                                            <tfoot>
                                                <tr class="border-top">
                                                    ...
                                                    <th class="text-right">{{$inv_item_amount}}</th>
                                                    <th class="text-right">{{$inv_item_tax}}</th>
                                                    <th class="text-right">{{$inv_item_net}}</th>
                            ...
                            <div class="card-footer">
                                <div class="row">
                                    <div class="col-md-12 text-right">
                                        <form method="POST" action="{{route('store-container-breakup-invoice-item', [$job->id, $inv->id])}}">
                                            @csrf
                                            <input type="hidden" name="job_id" value="<?= $job->id ?>" />
                                            <input type="hidden" name="job_invoice_id" value="<?= $inv->id ?>" />
