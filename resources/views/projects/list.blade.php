                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                <?php if (has_permission(174)) { ?>
                                    <a href="{{route('create-project')}}" class="btn btn-sm btn-primary">Add New</a>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <x-action-btn route="project" id="{{$row->id}}" privilegeEditId="175" privilegeDeleteId="176"  privilegeRestoreId="{{$row->deleted_at ? 177 : 0}}" />
                                            <?php /*
