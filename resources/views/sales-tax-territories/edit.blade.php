<x-layout-admin>
    <div class="row">
        <div class="col-12">
            <form method="post" action="{{route('update-sales-tax-territory', [$row->id])}}">
                @csrf
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-4">
                                <input type="text" id="head" name="head" value="{{$row->head}}" class="form-control" />
                                @error('head')
