<x-layout-admin>
    <div class="row">
        <div class="col-12">
            <form method="post" action="{{route('update-party', [$row->id])}}" enctype='multipart/form-data'>
                @csrf
                <div class="card">
                    ...
                    <div class="card-body">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <div class="row  align-items-center">
                                        ...
                                        foreach ($party_types as $party_type) {
                                            if (in_array($party_type->id, explode(',', $row->party_type_id))) {
                                                $checked = 'checked';
                                            } else {
                                                $checked = '';
                                            }
                                        ?>
                                            <div class="col-md-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="party_type_id[]" <?= $checked ?> value="<?= $party_type->id; ?>" id="<?= $party_type->title; ?>">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="text" id="bank_name" name="bank_name" value="{{$row->bank_name}}" class="form-control" />
                                @error('bank_name')
                                <div class="text-danger">{{$message}}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="text" id="ntn" name="ntn" value="{{$row->ntn}}" class="form-control" />
                                @error('ntn')
                                <div class="text-danger">{{$message}}</div>
                                @enderror
                            </div>
