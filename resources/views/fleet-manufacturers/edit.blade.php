<x-layout-admin>
    <div class="row">
        <div class="col-12">
            <form method="post" action="{{route('update-fleet-manufacturer', [$row->id])}}" enctype='multipart/form-data'>
                @csrf
                <div class="card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                <?php if (has_permission(227)) { ?>
                                    <a href="{{route('fleet-manufacturers')}}" class="btn btn-sm btn-primary">View All</a>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
