<x-layout-admin>
    <div class="row">
        <div class="col-12">
            <form method="post" action="{{route('update-privilege-group', [$row->id])}}">
                @csrf
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <x-combobox of="privilege_categories" label="Privilege Category" ref="privilege_category_id" selected="{{$row->privilege_category_id}}" inline=1 />
