<x-layout-admin>
    <div class="row">
        <div class="col-12">
            <form method="post" action="{{route('store-tank')}}">
                @csrf
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <x-combo-users selected="0" label="Supervisor" ref="user_id" />
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group mb-3">
                                    <input type="number" id="capacity" name="capacity" value="{{old('capacity')}}" class="form-control" />
