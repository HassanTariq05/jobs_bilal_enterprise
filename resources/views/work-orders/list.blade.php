            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-6">
                                <h5>List of all Pending Work Orders </h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <nav>
                            <div class="nav nav-tabs border-0 nav-justified" id="nav-tab" role="tablist">
                                <button class="nav-link  active" id="nav-tab-1" data-toggle="tab" data-target="#nav-1" type="button" role="tab" aria-controls="nav-1" aria-selected="true">
                                    Open
                                </button>
                                <button class="nav-link" id="nav-tab-2" data-toggle="tab" data-target="#nav-2" type="button" role="tab" aria-controls="nav-2" aria-selected="true">
                                    Closed
                                </button>
                            </div>
                        </nav>
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="nav-1" role="tabpanel" aria-labelledby="nav-tab-1">
                            <div class="card-body p-0">
                                <div class="table-responsive">
                                    <table class="table table-hover table-striped table-sm data-table" id="table-3">
                                        <thead>
                                            <tr>
                                                <th>Sr.</th>
                                                <th>BL No.</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">{{$row->pending_containers}}</td>
                        ...
                        <div class="tab-pane fade" id="nav-2" role="tabpanel" aria-labelledby="nav-tab-2">
                            <div class="card-body p-0">
                                <div class="table-responsive">
                                    <table class="table table-hover table-striped table-sm data-table" id="table-2">
                                        <thead>
                                            <tr>
                                                <th>Sr.</th>
                                                <th>BL No.</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">{{$row->pending_containers}}</td>
                                                <td style="width: 400px" class="text-center">
                                                    <?php if (has_permission(251)) { ?>
                                                    <a href="{{ route("post-work-order", $row->id) }}" onclick="return confirm('Are you sure you want to post this Work Order?')">
                                                    <button type="button" class="btn btn-outline-success post-details" data-id="{{$row->booking}}" >
