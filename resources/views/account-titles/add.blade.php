<x-layout-admin>
    <div class="row">
        <div class="col-12">
            <form method="post" action="{{route('store-account-title')}}" enctype='multipart/form-data'>
                @csrf
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <x-combobox of="account_natures" label="Nature of Account" ref="account_nature_id" inline=1 />
                        <div class="form-group row mb-4">
